        ...
        case 'nimble':
          try {
            ...
            var status = {
              ...
              rtmp: {
                live: !isEmpty(rtmpdata) && rtmpdata[0].app === 'live/mobile' ? true : false,
                rtt: !isEmpty(rtmpdata) && rtmpdata[0].app === 'live/mobile' ? 5 : null,
                bandwidth: !isEmpty(rtmpdata) && rtmpdata[0].app === 'live/mobile' ? Math.round(rtmpdata[0].streams[0].bandwidth / 1024) : null
              }
